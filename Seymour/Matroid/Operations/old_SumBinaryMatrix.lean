...
--   have x := BinaryMatroid.TwoSum.x M₁ M₂ Assumptions.ha
--   have y := BinaryMatroid.TwoSum.y M₁ M₂ Assumptions.ha
--   have A₁ := BinaryMatroid.TwoSum.A₁ M₁ M₂ Assumptions.ha
--   have A₂ := BinaryMatroid.TwoSum.A₂ M₁ M₂ Assumptions.ha
--   ⟨
--     (M₁.X \ {a}) ∪ M₂.X,
--     M₁.Y ∪ (M₂.Y \ {a}),
...
--         ⟨disjoint_of_singleton_inter_both_wo Assumptions.ha, M₂.hXY.disjoint_sdiff_right⟩
--       ⟩,
