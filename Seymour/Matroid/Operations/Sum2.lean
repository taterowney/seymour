...
structure Matroid.TwoSum.Assumptions {α : Type*} (M₁ M₂ : Matroid α) where
  /-- `M₁` and `M₂` are finite -/
  hM₁fin : M₁.Finite
  hM₂fin : M₂.Finite
...
/-- Ground set of `M₁ ⊕₂ M₂` -/
def Matroid.TwoSum.E {α : Type*} (M₁ M₂ : Matroid α) :=
  (M₁.E ∪ M₂.E) \ (M₁.E ∩ M₂.E)

/-- Type 1 of circuits in `M₁ ⊕₂ M₂`: circuits of `M₁` not containing common element of `M₁` and `M₂` -/
def Matroid.TwoSum.CircuitType1 {α : Type*} (M₁ M₂ : Matroid α) (C : Set α) : Prop :=
  M₁.Circuit C ∧ Disjoint C (M₁.E ∩ M₂.E)

/-- Type 2 of circuits in `M₁ ⊕₂ M₂`: circuits of `M₂` not containing common element of `M₁` and `M₂` -/
def Matroid.TwoSum.CircuitType2 {α : Type*} (M₁ M₂ : Matroid α) (C : Set α) : Prop :=
  M₂.Circuit C ∧ Disjoint C (M₁.E ∩ M₂.E)

/-- Type 3 of circuits in `M₁ ⊕₂ M₂`:
  sets `(C₁ ∪ C₂) \ (M₁.E ∪ M₂.E)` where `C₁` and `C₂` are circuits in `M₁` and M₂`, respectively -/
def Matroid.TwoSum.CircuitType3 {α : Type*} (M₁ M₂ : Matroid α) (C : Set α) : Prop :=
...
def Matroid.TwoSum.CircuitPred {α : Type*} (M₁ M₂ : Matroid α) : CircuitPredicate α :=
  fun C =>
...
def Matroid.TwoSum.Assumptions.symm {α : Type*} {M₁ M₂ : Matroid α} (Assumptions : Matroid.TwoSum.Assumptions M₁ M₂) :
...
lemma Matroid.TwoSum.Assumptions.inter_nonempty {α : Type*} {M₁ M₂ : Matroid α}
...
lemma Matroid.TwoSum.Assumptions.inter_singleton {α : Type*} {M₁ M₂ : Matroid α}
...
lemma Matroid.TwoSum.Assumptions.inter_singleton_not_loop_M₁ {α : Type*} {M₁ M₂ : Matroid α} {p : α}
...
lemma Matroid.TwoSum.Assumptions.inter_singleton_not_coloop_M₁ {α : Type*} {M₁ M₂ : Matroid α} {p : α}
...
lemma Matroid.TwoSum.E.disjoint_inter {α : Type*} (M₁ M₂ : Matroid α) :
    Disjoint (Matroid.TwoSum.E M₁ M₂) (M₁.E ∩ M₂.E) :=
  Set.disjoint_sdiff_left

/-- Ground sets minus their intersection are disjoint sets -/
lemma Matroid.TwoSum.disjoint_grounds_diff_inter {α : Type*} (M₁ M₂ : Matroid α) :
...
lemma Matroid.TwoSum.CircuitType1.circuit_M₁ {α : Type*} {M₁ M₂ : Matroid α} {C : Set α}
    (hC : Matroid.TwoSum.CircuitType1 M₁ M₂ C) : M₁.Circuit C := hC.1

/-- Circuit of type 1 is disjoint with `M₁.E ∩ M₂.E` -/
lemma Matroid.TwoSum.CircuitType1.disjoint_inter {α : Type*} {M₁ M₂ : Matroid α} {C : Set α}
    (hC : Matroid.TwoSum.CircuitType1 M₁ M₂ C) : Disjoint C (M₁.E ∩ M₂.E) := hC.2

/-- Circuit of type 1 lies in `M₁.E ∪ M₂.E` -/
lemma Matroid.TwoSum.CircuitType1.subset_union {α : Type*} {M₁ M₂ : Matroid α} {C : Set α}
...
lemma Matroid.TwoSum.CircuitType1.subset_ground {α : Type*} {M₁ M₂ : Matroid α} {C : Set α}
...
lemma Matroid.TwoSum.CircuitType1.subset_M₁_diff_inter {α : Type*} {M₁ M₂ : Matroid α} {C : Set α}
...
lemma Matroid.TwoSum.CircuitType1.disjoint_M₂ {α : Type*} {M₁ M₂ : Matroid α} {C : Set α}
...
lemma Matroid.TwoSum.CircuitType2.circuit_M₂ {α : Type*} {M₁ M₂ : Matroid α} {C : Set α}
    (hC : Matroid.TwoSum.CircuitType2 M₁ M₂ C) : M₂.Circuit C := hC.1

/-- Circuit of type 2 is disjoint with `M₁.E ∩ M₂.E` -/
lemma Matroid.TwoSum.CircuitType2.disjoint_inter {α : Type*} {M₁ M₂ : Matroid α} {C : Set α}
    (hC : Matroid.TwoSum.CircuitType2 M₁ M₂ C) : Disjoint C (M₁.E ∩ M₂.E) := hC.2

/-- Circuit of type 2 lies in `M₁.E ∪ M₂.E` -/
lemma Matroid.TwoSum.CircuitType2.subset_union {α : Type*} {M₁ M₂ : Matroid α} {C : Set α}
...
lemma Matroid.TwoSum.CircuitType2.subset_ground {α : Type*} {M₁ M₂ : Matroid α} {C : Set α}
    (hC : Matroid.TwoSum.CircuitType2 M₁ M₂ C) : C ⊆ Matroid.TwoSum.E M₁ M₂ :=
  Set.subset_diff.mpr ⟨hC.subset_union, hC.disjoint_inter⟩

/-- Circuit of type 2 lies in `M₂.E \ (M₁.E ∩ M₂.E)` -/
lemma Matroid.TwoSum.CircuitType2.subset_M₂_diff_inter {α : Type*} {M₁ M₂ : Matroid α} {C : Set α}
    (hC : Matroid.TwoSum.CircuitType2 M₁ M₂ C) : C ⊆ M₂.E \ (M₁.E ∩ M₂.E) :=
  Set.subset_diff.mpr ⟨hC.circuit_M₂.subset_ground, hC.disjoint_inter⟩

/-- Circuit of type 2 is disjoint with `M₁.E` -/
lemma Matroid.TwoSum.CircuitType2.disjoint_M₁ {α : Type*} {M₁ M₂ : Matroid α} {C : Set α}
...
def Matroid.TwoSum.CircuitType3.to_circuit_M₁ {α : Type*} {M₁ M₂ : Matroid α} {C : Set α}
...
def Matroid.TwoSum.CircuitType3.subset_ground {α : Type*} {M₁ M₂ : Matroid α} {C : Set α}
    (hC : Matroid.TwoSum.CircuitType3 M₁ M₂ C) : C ⊆ Matroid.TwoSum.E M₁ M₂ := hC.2.2

/-- Circuit of type 3 lies in `M₁.E ∪ M₂.E` -/
lemma Matroid.TwoSum.CircuitType3.subset_union {α : Type*} {M₁ M₂ : Matroid α} {C : Set α}
...
lemma Matroid.TwoSum.CircuitType3.disjoint_inter {α : Type*} {M₁ M₂ : Matroid α} {C : Set α}
...
lemma Matroid.TwoSum.CircuitType3.disjoint_inter_M₁_inter {α : Type*} {M₁ M₂ : Matroid α} {C : Set α}
    (hC : CircuitType3 M₁ M₂ C) : Disjoint (C ∩ M₁.E) (M₁.E ∩ M₂.E) :=
  hC.disjoint_inter.inter_left M₁.E

/-- Circuit of type 3 has nonempty intersection with `M₁.E` -/
lemma Matroid.TwoSum.CircuitType3.inter_M₁_nonempty {α : Type*} {M₁ M₂ : Matroid α} {C : Set α}
    (Assumptions : Matroid.TwoSum.Assumptions M₁ M₂) (hC : CircuitType3 M₁ M₂ C) : (C ∩ M₁.E).Nonempty := by
  by_contra hCM₁empty
...
lemma Matroid.TwoSum.CircuitType1.not_ssubset_circuit_type_1 {α : Type*} {M₁ M₂ : Matroid α} {C₁ C₁' : Set α}
...
lemma Matroid.TwoSum.CircuitType1.disjoint_circuit_type_2 {α : Type*} {M₁ M₂ : Matroid α} {C₁ C₂ : Set α}
...
lemma Matroid.TwoSum.CircuitType1.not_ssubset_circuit_type_2 {α : Type*} {M₁ M₂ : Matroid α} {C₁ C₂ : Set α}
    (hC₁ : Matroid.TwoSum.CircuitType1 M₁ M₂ C₁) (hC₂ : Matroid.TwoSum.CircuitType2 M₁ M₂ C₂) :
    ¬C₁ ⊂ C₂ :=
...
lemma Matroid.TwoSum.CircuitType1.not_ssubset_circuit_type_3 {α : Type*} {M₁ M₂ : Matroid α} {C₁ C₃ : Set α}
...
lemma Matroid.TwoSum.CircuitType1.not_ssubset_circuit {α : Type*} {M₁ M₂ : Matroid α} {C₁ C : Set α}
    (Assumptions : Matroid.TwoSum.Assumptions M₁ M₂)
...
lemma Matroid.TwoSum.CircuitType2.disjoint_circuit_type_1 {α : Type*} {M₁ M₂ : Matroid α} {C₁ C₂ : Set α}
...
lemma Matroid.TwoSum.CircuitType2.not_ssubset_circuit_type_1 {α : Type*} {M₁ M₂ : Matroid α} {C₁ C₂ : Set α}
    (hC₂ : Matroid.TwoSum.CircuitType2 M₁ M₂ C₂) (hC₁ : Matroid.TwoSum.CircuitType1 M₁ M₂ C₁) :
    ¬C₂ ⊂ C₁ :=
...
lemma Matroid.TwoSum.CircuitType2.not_ssubset_circuit_type_2 {α : Type*} {M₁ M₂ : Matroid α} {C₂ C₂' : Set α}
...
lemma Matroid.TwoSum.CircuitType2.not_ssubset_circuit_type_3 {α : Type*} {M₁ M₂ : Matroid α} {C₂ C₃ : Set α}
    (Assumptions : Matroid.TwoSum.Assumptions M₁ M₂)
...
lemma Matroid.TwoSum.CircuitType2.not_ssubset_circuit {α : Type*} {M₁ M₂ : Matroid α} {C₂ C : Set α}
    (Assumptions : Matroid.TwoSum.Assumptions M₁ M₂)
...
lemma Matroid.TwoSum.CircuitType3.not_ssubset_circuit_type_1 {α : Type*} {M₁ M₂ : Matroid α} {C₁ C₃ : Set α}
    (Assumptions : Matroid.TwoSum.Assumptions M₁ M₂)
...
lemma Matroid.TwoSum.CircuitType3.not_ssubset_circuit_type_2 {α : Type*} {M₁ M₂ : Matroid α} {C₂ C₃ : Set α}
    (Assumptions : Matroid.TwoSum.Assumptions M₁ M₂)
...
lemma Matroid.TwoSum.CircuitType3.not_ssubset_circuit_type_3 {α : Type*} {M₁ M₂ : Matroid α} {C₃ C₃' : Set α}
...
lemma Matroid.TwoSum.CircuitType3.not_ssubset_circuit {α : Type*} {M₁ M₂ : Matroid α} {C₃ C : Set α}
    (Assumptions : Matroid.TwoSum.Assumptions M₁ M₂)
...
lemma Matroid.TwoSum.CircuitPred.not_circuit_empty {α : Type*} {M₁ M₂ : Matroid α}
...
lemma Matroid.TwoSum.CircuitPred.circuit_not_ssubset {α : Type*} {M₁ M₂ : Matroid α}
...
/-- todo: desc -/
lemma Matroid.TwoSum.CircuitPred.subset_ground {α : Type*} (M₁ M₂ : Matroid α) :
...
def Matroid.TwoSum.CircuitMatroid {α : Type*} {M₁ M₂ : Matroid α} (Assumptions : Matroid.TwoSum.Assumptions M₁ M₂) :
...
/-- todo: desc -/
def Matroid.TwoSum.matroid {α : Type*} {M₁ M₂ : Matroid α} (Assumptions : Matroid.TwoSum.Assumptions M₁ M₂) : Matroid α :=
  (Matroid.TwoSum.CircuitMatroid Assumptions).matroid

@[simp]
lemma Matroid.TwoSum.E_eq {α : Type*} {M₁ M₂ : Matroid α} (Assumptions : Matroid.TwoSum.Assumptions M₁ M₂) :
    (Matroid.TwoSum.matroid Assumptions).E = (M₁.E ∪ M₂.E) \ (M₁.E ∩ M₂.E) := rfl

@[simp]
lemma Matroid.TwoSum.CircuitPred_iff {α : Type*} {M₁ M₂ : Matroid α} (Assumptions : Matroid.TwoSum.Assumptions M₁ M₂) :
  (Matroid.TwoSum.CircuitMatroid Assumptions).CircuitPred = Matroid.TwoSum.CircuitPred M₁ M₂ := rfl

@[simp]
lemma Matroid.TwoSum.circuit_iff {α : Type*} {M₁ M₂ : Matroid α} (Assumptions : Matroid.TwoSum.Assumptions M₁ M₂) {C : Set α} :
