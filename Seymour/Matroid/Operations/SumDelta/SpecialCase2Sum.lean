    ...
    | inl X₂_dep =>
      have X₂_eq : X₂ = M₁.E ∩ M₂.E :=
        ...
        have inter_encard_le_X₂_encard := le_of_eq_of_le assumptions.interSingleton
          (Set.one_le_encard_iff_nonempty.mpr X₂_dep.nonempty)
...
lemma BinaryMatroid.DeltaSum.CircuitForm3.sum2_circuit_pred {C : Set α} {p : α}
  ...
  · intro D hD hDC
    ...
    · rw [(Set.diff_union_inter X₁ X₂).symm]
      ...
      have hXXE := Set.diff_subset_iff.mpr (Set.subset_union_of_subset_right hX₁.subset_ground X₂)
    ...
    | inl X₁_dep =>
      ...
      | inl X₂_dep =>
        replace hCX₂ := hCpM₂.right X₂_dep hCX₂
        have hXXp : X₁ ∩ X₂ = {p} :=
          hXX.antisymm (Set.subset_inter (Set.union_subset_iff.mp hCX₁).right (Set.union_subset_iff.mp hCX₂).right)
      ...
      | inr X₂_empty =>
        ...
        have hpX₁ := hDXX ▸ (Set.union_subset_iff.mp hCX₁).right
  ...
  · intro hC
    ...
    · have ⟨⟨_, _, X₁, X₂, hCXX, hX₁, hX₂⟩, C_min⟩ := hC
      if is_X₂_empty : X₂ = ∅ then
        ...
        exact ⟨BinaryMatroid.DeltaSum.CircuitPred_udc_M₁ hC (hCXX ▸ hX₁), (Set.subset_diff.mp hCE).right⟩
      else
        right
        if is_X₁_empty : X₁ = ∅ then
          left
          ...
          right
          apply Set.nonempty_iff_ne_empty.mpr at is_X₁_empty
          apply Set.nonempty_iff_ne_empty.mpr at is_X₂_empty
          ...
          have hpX₁ : {p} ⊆ X₁ := by
            ...
            have disjoint_X₁_p : X₁ ⫗ {p} := Set.disjoint_singleton_right.mpr p_notin_X₁
            ...
            have ⟨Y₁, hY₁, Y₁_sub_X₁⟩ := M₁.toMatroid.dep_iff_has_circuit.mp X₁_dep
            ...
            replace hXX : X₁ ⫗ X₂ := Set.disjoint_iff_inter_eq_empty.mpr hXX
            rw [C_eq_X₁] at C_eq_union
            have X₂_empty := (Set.disjoint_of_subset_iff_left_eq_empty (Set.union_eq_left.mp C_eq_union.symm)).mp hXX.symm
          ...
          have hpX₂ : {p} ⊆ X₂ := by
            ...
            have ⟨Y₂, hY₂, hY₂X₂⟩ := M₂.toMatroid.dep_iff_has_circuit.mp X₂_dep
            ...
            replace hXX : X₁ ⫗ X₂ := Set.disjoint_iff_inter_eq_empty.mpr hXX
            have X₁_empty := (Set.disjoint_of_subset_iff_left_eq_empty (Set.union_eq_left.mp C_eq_union.symm)).mp hXX
            exact Set.not_nonempty_empty (X₁_empty ▸ is_X₁_empty)
          ...
          · rw [inter_eq_p] at hCXX
            ...
            rw [Set.union_eq_left.mpr hpXX] at hCpXXpp
            ...
            have eq_X₁ : X₁ ∩ M₁.E = X₁ := (Set.left_eq_inter.mpr hX₁.subset_ground).symm
            ...
            have p_inter : {p} ∩ M₁.E = {p} := (Set.left_eq_inter.mpr p_sub_E₁).symm
            rw [p_inter] at hCpE₁
          ...
          · intro M₁_circ_p
            exact assumptions.inter_singleton_not_loop_M₁ hp ((Matroid.Loop.iff_circuit M₁.toMatroid).mpr M₁_circ_p)
          -- todo: make lemma in Sum2
          have M₂_noncirc_p : ¬(M₂.toMatroid.Circuit {p})
          · intro M₂_circ_p
            exact assumptions.inter_singleton_not_loop_M₂ hp ((Matroid.Loop.iff_circuit M₂.toMatroid).mpr M₂_circ_p)
          ...
          · rw [hCXX, inter_eq_p, Set.union_diff_distrib, Set.union_inter_distrib_right]
            ...
            exact (Set.left_eq_inter.mpr sub_E₁ ▸ not_X₁_sub_p).inl
          have C_inter_E₂_nonempty : (C ∩ M₂.E).Nonempty
          · rw [hCXX, inter_eq_p, Set.union_diff_distrib, Set.union_inter_distrib_right]
            rw [←Set.diff_nonempty] at not_X₂_sub_p
            have X₂_sub_E₂ : X₂ ⊆ M₂.E := X₂_dep.subset_ground
            have sub_E₂ : X₂ \ {p} ⊆ M₂.E := diff_subset_parent X₂_sub_E₂
            exact (Set.left_eq_inter.mpr sub_E₂ ▸ not_X₂_sub_p).inr
          have M₁_circ_X₁ : M₁.toMatroid.Circuit X₁
          · constructor
            · exact X₁_dep
            · intro Y₁ hY₁ Y₁_sub_X₁
              have ⟨Z₁, hZ₁, Z₁_sub_Y₁⟩ := M₁.toMatroid.dep_iff_has_circuit.mp hY₁
              ...
              if p_sub_Z₁ : {p} ⊆ Z₁ then
                ...
                · by_contra! hZ₁dp
                  have hZ₁eqp : Z₁ = {p} := (Set.diff_eq_empty.mp hZ₁dp).antisymm p_sub_Z₁
          ...
          · constructor
            ...
            · intro Y₂ hY₂ Y₂_sub_X₂
              ...
              if p_sub_Z₂ : {p} ⊆ Z₂ then
                ...
                have hZ₂dp : (Z₂ \ {p}).Nonempty
                · by_contra! hZ₂dp
                  have Z₂_eq_p : Z₂ = {p} := (Set.diff_eq_empty.mp hZ₂dp).antisymm p_sub_Z₂
                ...
                · rw [hpX₁Z₂, hCXX, inter_eq_p, Set.union_diff_distrib, Set.union_diff_distrib] at C_min
                  simp only [Set.le_eq_subset] at C_min
                  have hX₂union := (Set.union_subset_iff.mp C_min).right
                  have hX₂Z₂dp : X₂ \ {p} ⊆ Z₂ \ {p} :=
